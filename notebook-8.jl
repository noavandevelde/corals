...
odesys = convert(ODESystem, Corals)
...
md"Bovenstaande differentiaalvergelijkingen werden vervolgens opgelost met behulp van volgende k-waarden en initiële waarden."
...
md"Al de initiële waarden zijn afkomstig uit het oorspronkelijke iGEM project (4)."
...
# ╔═╡ 4d6e89f1-3ce6-4e7a-aeef-bf86c39339fe
...
prob = ODEProblem(odesys, u₀map, (1e-8, 100), pmap)
...
begin
    ...
    plot!(Data[:,1], Data[:,2],label = "Genetisch circuit")
...
begin
    ...
    plot!(Data[:,1], Data[:,4],label = "Genetisch circuit")
...
function simulate_corals(k₁ = 1, k₂ = 0.001, k₃ = 10, k₄ = 0, k₅ = 1.5*10^(-9), k₆ = 4*10^-7, k₇ = 0.1, k₈ = 0.0002,  k₉ = 320, k₁₀ = 160, k₁₁ = 8.2*10^-9, k₁₂ = 3*10^-6)
	prob = ODEProblem(odesys, u₀map, (0, 100), (k₁,k₂,k₃,k₄,k₅,k₆,k₇,k₈,k₉, k₁₀,k₁₁,k₁₂))
...
md"Op de grafiek van het natuurlijk systeem is te zien dat wanneer k₅ afwijkt van de gekozen waarde (1.65e-9) het evenwicht niet bewaard wordt (bij 25°C). ROS stijgt als k₅ kleiner is en ROS daalt wanneer k₅ groter is.
...
md"ROS is in het natuurlijk circuit veel gevoeliger voor k_5 dan in het genetisch circuit."

# ╔═╡ d5b3cb59-ccef-4591-a2c3-317b063f4323
md"### Extra functies bij Monte Carlo analyse"
...
md"Dit is de code die gebruikt werd om de kleuren van de grafiek vast te stellen zodat deze duidelijk interpreteerbaar is."
...
md"Hieronder kan gezien worden hoe de grafiek opgesteld werd."
...
pmc1 = plotMC(throws1; title="MC on ROS in Nat\n(sample from k₅)")

# ╔═╡ 3bfb7cbd-5c4f-4db3-8a40-4ed261d44f50
pcm2 = plotMC(throws2; title="MC on ROS in Genetic Circuit\n(sample from k₅)")
