...
# ╔═╡ f7585970-ca0f-11ec-101c-b191f6ec253d
using Catalyst, DifferentialEquations , ModelingToolkit , Plots, PlutoUI ,Images, FileIO , QuasiMonteCarlo, Statistics, GlobalSensitivity, OrdinaryDiffEq, Plots, DataFrames, Distributions

# ╔═╡ e2e61c22-2db8-4662-a684-6a1bf051058f
md"# Modelleren van algen in koralen"

# ╔═╡ 3fc987d4-3058-4ac7-882c-d71e069c258c
md"Het Great Barrier Reef, gelegen aan de kust van Queensland in Australië, is het grootste koraalrif ter wereld. Het is een prachtig ecosysteem waarvan de ecosysteemdiensten een vitale functie uitoefenen voor veel plaatselijke gemeenschappen. In 1997 werd duidelijk dat klimaatsverandering een negatieve invloed had op de werking van het rif, dit jaar werd dan ook uitgeroepen tot jaar van het rif.

Fastforward naar 2020, waar het Australische team van de iGEM-competitie dit complex probleem door middel van een genetisch circuit probeert aan te pakken. Zij focusten op de invloed van een temperatuursstijging op de symbiose tussen het koraal en micro-algen zoals \textit{Symbiodinium} spp.. Wanneer de temperatuur van het zeewater in het rif stijgt, verliezen deze micro-algen hun functie, doordat reactieve zuurstofspecies (ROS) vrijkomen. Hierdoor denatureren de eiwitten in het organisme, dit principe heet oxidatieve stress. Dit leidt dan ook uiteindelijk tot \textit{coral bleaching}."

# ╔═╡ 6aac4578-851c-4b81-8b77-e37dba566d94
md"Het doel van dit model is om de invloed van het genetisch circuit ontworpen door het Australische UNSW team (3) aan te tonen. Dit genetisch circuit is gebaseerd op hun project en ontworpen om algen beter bestand te maken tegen oxidatieve stress door temperatuursstijging."

# ╔═╡ 5ed54026-0150-4adf-96c6-b1c36d932d65
md"## Simulatie van het model"

# ╔═╡ d9dd8167-d9a8-4265-a366-a13b3718b3be
md"Het natuurlijk systeem omvat de natuurlijke ROS en proteïne productie en degradatie en de invloed van ROS op misfolding van proteïnen. Dit wordt met volgende reacties voorgesteld:"

# ╔═╡ 668d5d4c-45dc-4a1b-a721-831ac58cd963
...
# ╔═╡ b0895e88-fdb7-416b-ae0a-e394adc40806
md"Het volgende systeem bevat het geïmplementeerde genetisch circuit. Als ROS in voldoende grote concentratie aanwezig is activeert het de OxyR transcriptiefactor die de expressie van *heat shock proteins (HSP's)* en gereduceerd glutathion stimuleert. HSP's vouwen *misfolded proteins* correct op en het glutathion wordt geoxideerd om zo reactieve zuurstofspecies als H₂O₂ te neutraliseren. Nadien wordt het geoxideerd glutathion terug gereduceerd."

# ╔═╡ 01ddd46a-d155-48b5-a8d5-28388f86079c
...
k₆, ROS + InactOxyR --> ActOxyR + ROS

k₇, ActOxyR --> ReducedGlutathione + HSP + InactOxyR

k₈, HSP + MisP --> NatP + HSP

k₉, ROS + ReducedGlutathione --> OxidisedGlutathione

k₁₀, OxidisedGlutathione --> ReducedGlutathione 

k11, HSP --> ∅

end k₁ k₂ k₃ k₄ k₅ k₆ k₇ k₈ k₉ k₁₀ k11

# ╔═╡ 6bccec83-9211-45f0-b715-1258230f7025
md"Beide systemen werden opgelost met behulp van volgende differentiaalvergelijkingen:"

# ╔═╡ 52a224e8-0c35-4957-b1e9-15f0b48157fd
odesysNat = convert(ODESystem, CoralsNat)

# ╔═╡ 2d7060c5-2ec4-4c92-bde2-bfe6d6745377
odesysGen = convert(ODESystem, Corals)

# ╔═╡ d9648455-7740-4d66-9079-076f111eeaac
md"Bovenstaande differentiaalvergelijkingen werden vervolgens opgelost met behulp van volgende k-waarden en initiële waarden van de variabelen."

# ╔═╡ 653ebf5d-530a-46dc-9b0c-dad2149589ca
md"k₁ tot en met k₄, k₈, k₁₁ en k₁₂ zijn gebaseerd op onderzoek van Proctor et al. (2). k₆ werd berekend op basis van informatie verkregen van het onderzoek van ÅSlund et al. (1). k₉ en k₁₀ komen uit een iGEM project (4), enkel de waarde van k₁₀ is in dit model wat verlaagd omdat het hier om een zeer snelle reactie gaat. Voor k₇ was er geen experimentele waarde, dit is de vertraging in het systeem door de werking van OxyR. Tot slot is er een andere waarde voor k₅ gebruikt om ervoor te zorgen dat het natuurlijk systeem in evenwicht bleef."

# ╔═╡ 0f9912b7-3139-47b0-a636-6737780728c3
md"Alle initiële waarden van de variabelen zijn afkomstig uit het oorspronkelijke iGEM project (4)."

# ╔═╡ 7c6d8f44-8050-4c2f-8f2b-15142961e7a7
md"Hieronder worden de differentiaalvergelijkingen opgelost. Eerst wordt er een ODEProblem van gemaakt met behulp van de reactiesnelheidsconsten en initiële waarden. Dit wordt vervolgens opgelost volgens de Rosenbrock methode voor stijve differentiaalvergelijkingen."

# ╔═╡ ee0f31e0-2e12-4082-8679-28389dc8e806
...
# ╔═╡ 2ba5b891-0b74-4f8c-abdc-887c3abe0aef
md"Bij 25°C is zowel ROS als MisP in evenwicht voor het natuurlijk systeem. Als de temepratuur echter opgedreven wordt, is evolueren ROS en MisP in stijgende lijn in functie van de tijd. Er is ook te zien dat het genetisch circuit zijn werk doet, want het zal zowel ROS als MisP afbreken bij elke temperatuur."

# ╔═╡ d643ac00-60d4-4354-af7d-e36803546528
md"## Monte Carlo analyse voor onzekerheid over k₅"

# ╔═╡ 220fc51c-22e3-4125-929a-70e9ed7074d3
md"Omdat de snelheidparameter k₅ niet uit de literatuur gehaald kon worden, werd besloten om voor deze parameter een onzekerheidsanalyse uit te voeren op basis van de Monte Carlo methode. Hiermee wordt getest wat de invloed van deze parameter op het model is."

# ╔═╡ 139978d4-a24b-44fb-acae-0b92a0103b3f
md"Hiervoor werd eerst een lognormale verdeling opgesteld rond k₅."

# ╔═╡ 32e0a9f2-7d1e-4dad-bea9-0bf219e9d8ad
md" Uit deze verdeling kan kan onderstaande Monte Carlo functie willekeurige waarden nemen om zo het functieverloop van het model te bepalen voor verschillende waarden van k₅. Deze functie werd tweemaal toegepast, zowel voor het natuurlijke systeem als voor het gentische circuit."

# ╔═╡ d0298f3e-0299-44c4-9ec3-84e9fa8d6c80
function monte_carlo(simulator::Function, Pθ::Sampleable; n=1000)
	θs = [rand(Pθ) for i in 1:n]
	xs = [simulator(1,0.001,10,0, θ , 4*10^-7, 0.1, 0.0002,  320,  160,  8.2*10^-9,  3*10^-6) for θ in θs]
	return xs, θs
end;

# ╔═╡ 1c9aa5c3-5981-40a4-bfb6-0b90537f8c17
function monte_carloNat(simulator::Function, Pθ::Sampleable; n=1000)
	θs = [rand(Pθ) for i in 1:n]
	xs = [simulator(1,0.001,10,0, θ ,3*10^-6) for θ in θs]
	return xs, θs
end;

# ╔═╡ 76c92ee3-d08e-458b-90ec-fd3b3bee0a69
md"Zoals te zien is heeft de Monte Carlo functie nood aan een simulator functie. Deze functie is hieronder aangegeven (opnieuw voor het natuurlijk systeem en het genetisch circuit) en zal het model simuleren op vooraf bepaalde tijdstippen. Deze tijdstippen zijn meegeven via tsteps."

# ╔═╡ 973bac12-54a0-4c74-8c1b-2e74716606d4
tsteps = 0:0.5:100

# ╔═╡ a4b1794b-08c0-4590-8007-71f6bc3001fa
...
# ╔═╡ e082ca77-a87b-49af-942d-3cfd6c175520
md"Op de grafiek van het natuurlijk systeem is te zien dat wanneer k₅ afwijkt van de gekozen waarde (1.5e-9) het evenwicht niet bewaard wordt (bij 25°C). ROS stijgt als k₅ kleiner is en ROS daalt wanneer k₅ groter is.

Bij het genetisch circuit is te zien dat het circuit ROS voor elke waarde van k₅ afbreekt, hetzij wat sneller of wat trager."

# ╔═╡ 324b2d89-d07f-4cd3-b266-9d2c8319520c
md"CONCLUSIE ???"

# ╔═╡ 8caed582-85fc-44d4-9690-25f563a71e4e
md"### Extra code bij simulatie van het model"

# ╔═╡ b6788ee2-8a6e-45c8-b19d-d5a62e400b5a
md"Om goed te kunnen plotten werd de data van de solver in een dataframe opgeslaan."

# ╔═╡ 1ca95931-72c6-425e-9c99-845544b4d68a
md"Volgende functies werden gebruikt om de temperatuurslider aan te maken."

# ╔═╡ bfdc1dce-85a9-4e7e-84f5-e88d48b76b20
struct MySlider 
    range::AbstractRange
    default::Number
end

# ╔═╡ 2e1b846b-da7a-4593-a87b-dfc915ed67a0
...
# ╔═╡ b55500d8-8e55-4e1b-835b-148529066f77
md"Temperatuur: $(@bind temp MySlider(25:40, 25)) °C"

# ╔═╡ f3ff024b-363c-46c9-a956-40251d849feb
factor = exp(-100000/(8.314*(temp+273)))/exp(-100000/(8.314*298))

# ╔═╡ 1bbbde57-6a13-4c92-91ed-91e4ac9ad58e
md"##"

# ╔═╡ 0136c1a1-eec6-4a96-aff5-127a3909f0d0
@parameters k₁ k₂ k₃ k₄ k₅ k₆ k₇ k₈ k₉ k₁₀ k11 k₁₂

# ╔═╡ 614dc75d-59e1-4bf5-8d63-0073fc38cb0e
pmap = (k₁ => 1*factor, k₂ => 0.00001, k₃ => 10, k₄ => 0, k₅ => 0.00000000165, k₆ => 20, k₇ => 0.1, k₈ => 0.0002,  k₉ => 20, k₁₀ => 0.1, k11 => 8.02*10^-9, k₁₂ => 6*10^-7)

# ╔═╡ 6b6adb7e-0aca-430c-a5f7-4b80139a983a
@variables t NatP(t) ROS(t) MisP(t) HSP(t) ReducedGlutathione(t) OxidisedGlutathione(t) ActOxyR(t) InactOxyR(t) 

# ╔═╡ 97992562-39e8-47bb-99a7-e78d3e424bf5
u₀map = [NatP => 6000000., ROS => 100., MisP => 300000., HSP => 0., ReducedGlutathione => 0., OxidisedGlutathione=> 0., InactOxyR => 10., ActOxyR => 0.]

# ╔═╡ 0d1e0418-1837-4efa-a572-4bfd4bbf50e5
probNat = ODEProblem(odesysNat, u₀map, (1e-8, 100), pmap)

# ╔═╡ 3ac29245-511e-4d10-8f04-ab5efd5106b1
solNat = solve(probNat, Rosenbrock23())

# ╔═╡ a02ad3a9-8893-40c0-9199-8ce6b5a1f9d7
DataNat  = DataFrame(solNat)

# ╔═╡ ea76d4cf-aabc-4236-997d-598d33423490
probGen = ODEProblem(odesysGen, u₀map, (1e-8, 100), pmap)

# ╔═╡ 117e937e-eab0-4298-9c47-71cd17d81e61
solGen = solve(probGen, Rosenbrock23())

# ╔═╡ c3f6a6cc-7c43-4e8a-86b4-07567651e0a1
DataGen = DataFrame(solGen)

# ╔═╡ feedf644-0069-4ca5-ab4f-a66ccb7b2223
begin
...
# ╔═╡ 004c7128-f6c2-422e-bb86-a8a8733508bc
begin
...
# ╔═╡ 80f40f9b-05d1-4481-a8a2-add6ec24b743
function simulate_corals(k₁ = 1, k₂ = 0.001, k₃ = 10, k₄ = 0, k₅ = 1.5*10^(-9), k₆ = 4*10^-7, k₇ = 0.1, k₈ = 0.0002,  k₉ = 320, k₁₀ = 160, k₁₁ = 8.2*10^-9, k₁₂ = 3*10^-6)
	prob = ODEProblem(odesysGen, u₀map, (0, 100), (k₁,k₂,k₃,k₄,k₅,k₆,k₇,k₈,k₉, k₁₀,k₁₁,k₁₂))
	return solve(prob, saveat=tsteps, Rosenbrock23())[1,:]
end;

# ╔═╡ 2c5d409c-cc64-424b-8832-db1ef675996f
function simulate_coralsNat(k₁ = 1, k₂ = 0.001, k₃ = 10, k₄ = 0, k₅ = 1.5*10^(-9), k₁₂ = 3*10^-7)
	probNat = ODEProblem(odesysNat, u₀map, (0, 100), (k₁,k₂,k₃,k₄,k₅,k₁₂))
	return solve(probNat, saveat=tsteps, Rosenbrock23())[1,:]
end;

# ╔═╡ d5b3cb59-ccef-4591-a2c3-317b063f4323
md"### Extra code bij Monte Carlo analyse"

# ╔═╡ f8c6a873-16a8-4518-8ef0-26b6dafd7e41
md"k₅_star is de startwaarde van k₅ voor de Monte Carlo analyse." 

# ╔═╡ f6f1a40e-6582-47c9-b948-43ae6ad2e5b4
k₅_star = 1.5*10^(-9)

# ╔═╡ c17f262c-1174-4fce-a72b-706230dad468
Pk₅ = LogNormal(log(k₅_star), 0.25)

# ╔═╡ 41ace01e-bb29-434c-9e25-e1b0c712f232
md"Dit is de code die gebruikt werd om de kleuren van de grafieken bij de Monte Carlo analyse vast te stellen zodat deze duidelijk interpreteerbaar is."

# ╔═╡ b5f99ffd-b9c9-4cf9-93f6-0ea6c06bba41
begin
	myblue = "#304da5"
	mygreen = "#2a9d8f"
	myyellow = "#e9c46a"
...
# ╔═╡ 017e344c-001a-46f6-9617-7500b44924fb
md"Hieronder kan gezien worden hoe de grafieken bij de Monte Carlo analyse opgesteld werden."

# ╔═╡ 41081751-48a4-4a7b-b2e1-e8a1195d5447
function plotMC(throws; kwargs...)
	...
	plot!(p, tsteps, mean(throws), label="simulatie gemiddelde", color=myred, lw=2)
	return p
end

# ╔═╡ 08f78012-ffbc-4faf-930b-b663f564eeec
md"Data voor de grafieken bij Monte Carlo analyse:"

# ╔═╡ 02d40ca4-aa82-4341-94c3-fc77f907cd39
throws1, θs1 = monte_carloNat(simulate_coralsNat, Pk₅, n = 100)

# ╔═╡ df843552-d07d-4cb5-946d-d6e589a9234f
pmc1 = plotMC(throws1; title="MC voor ROS in het natuurlijk systeem\n(steekproef van k₅)")

# ╔═╡ 62f34e46-02b9-4680-bc20-395f8007b34c
throws2, θs2 = monte_carlo(simulate_corals, Pk₅, n = 100)

# ╔═╡ 3bfb7cbd-5c4f-4db3-8a40-4ed261d44f50
...
FileIO = "~1.13.0"
GlobalSensitivity = "~1.3.2"
Images = "~0.25.2"
ModelingToolkit = "~8.8.1"
